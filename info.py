...
PICS = (environ.get('PICS', 'https://graph.org/file/9f59dd688fb3f7bc6c2f9.jpg https://graph.org/file/7fa0095f3e5a4c8923afd.jpg')).split() #SAMPLE PIC
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "DATABASE_URI=mongodb+srv://Madhan:N0password@cluster0.y0vtta6.mongodb.net/?retryWrites=true&w=majority")
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "https://intelligent-florette-file-search-robot-0f4257ee.koyeb.app/")
