...
from utils import get_settings, pub_is_subscribed, get_size, is_subscribed, save_group_settings, temp, verify_user, check_token, check_verification, get_token, get_shortlink, get_tutorial, get_seconds, generate_referral_buttons, handle_callback
            ...
            if not await db.has_premium_access(message.from_user.id):
                if not await check_verification(client, message.from_user.id) and VERIFY == True:
                    btn = [[
                        ...
                        InlineKeyboardButton("Get free subscription", callback_data="generate_referral_buttons")
                    ]]
                    await message.reply_text(
